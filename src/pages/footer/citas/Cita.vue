...
<div>
    ...
    <q-modal v-model="popup_vehiculo" maximized :content-css="{padding:'20px 20px 100px 20px',}">
        <div class="row">
            ...
            <!--GNM+{ -->  
            <div class="col-2">
                <button @click="filtrar_autos_placa" id="idBtnFiltro" class="q-btn inline relative-position q-btn-item non-selectable btnAdd q-btn-rectangle q-focusable q-hoverable bg-primary text-white" 
                style="padding-left: 18px;padding-bottom: 1px;padding-top: 1px;padding-right: 18px;"
                >
